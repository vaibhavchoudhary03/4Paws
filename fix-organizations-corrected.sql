-- Fix for 500 error when fetching organizations (CORRECTED VERSION)
...
-- 6. Test if we can read from the table without RLS (using correct columns)
...
-- 9. Test the policy (using correct columns)
